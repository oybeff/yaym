...
function validateStep(step) {
  ...
  if (step === 1) {
    ...
    if (!lastName || !isNaN(lastName)) {
      document.getElementById('last-name-error').innerText = 'Please enter a valid last name.';
      valid = false;
    }
    if (!firstName || !isNaN(firstName)) {
      document.getElementById('first-name-error').innerText = 'Please enter a valid first name.';
      valid = false;
    }
  } else if (step === 2) {
    ...
    if (!month || isNaN(month) || month < 1 || month > 12 || !day || isNaN(day) || day < 1 || day > 31 || !year || isNaN(year) || !hour || isNaN(hour) || hour < 0 || hour > 23 || !minute || isNaN(minute) || minute < 0 || minute > 59) {
      document.getElementById('dob-error').innerText = 'Please enter a valid date and time.';
      valid = false;
    }
  } else if (step === 3) {
    ...
    if (!region || !isNaN(region)) {
      document.getElementById('location-error').innerText = 'Please enter a valid region.';
      valid = false;
    }
    if (!country || !isNaN(country)) {
      document.getElementById('location-error').innerText = 'Please enter a valid country.';
      valid = false;
    }
  } else if (step === 4) {
...
function submitForm() {
  if (validateStep(4)) {
    ...
    if (year >= 1950 && year <= 1960) {
      element = 'Yin Earth';
      elementDescription = 'Nurturing, charismatic, peaceful: You are the soft soil of the garden.';
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-earth-gif.gif?v=1615323006&width=714';
      elementSuggestions = `
    ...
    if (year >= 1961 && year <= 1971) {
      element = 'Yang Water';
      elementDescription = 'active, intelligent, straightforward: You are the vast and powerful ocean.';
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-water-gif.gif?v=1615323057&width=1000';
      elementSuggestions = `
        <p onclick="toggleDescription('socializing')">
          Socializing <span id="socializing-sign">+</span>
        </p>
    ...
    if (year >= 1972 && year <= 1983) {
      element = 'Yang Wood';
      elementDescription = 'self-confident, helpful, principled: Like a tall tree, you are strong and your roots go deep.';
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-wood-gif_06d5a34f-8630-400e-b6b0-c9eea96a73d7.gif?v=1615323244&width=1000';
      elementSuggestions = `
        <p onclick="toggleDescription('socializing')">
          Socializing <span id="socializing-sign">+</span>
        </p>
    ...
    if (year >= 1994 && year <= 2005) {
      ...
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-fire-gif.gif?v=1615323018&width=1280';
      elementSuggestions = `
        <p onclick="toggleDescription('socializing')">
          Socializing <span id="socializing-sign">+</span>
        </p>
    ...
    if (year >= 2006 && year <= 2016) {
      element = 'Yang Metal';
      elementDescription = 'strong personality, resolute, loyal: You are the strong sword';
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-metal-gif.gif?v=1615323035&width=1280';
      elementSuggestions = `
        <p onclick="toggleDescription('socializing')">
          Socializing <span id="socializing-sign">+</span>
        </p>
    ...
    if (year >= 2017 && year <= 2027) {
      element = 'Yin Water';
      elementDescription = 'gentle, peaceful, patient: You are the drop of water, the morning dew.';
      elementImage = 'https://www.theharmonist.eu/cdn/shop/files/harmonist-elements-page-water-gif.gif?v=1615323057&width=1000';
      elementSuggestions = `
        <p onclick="toggleDescription('socializing')">
          Socializing <span id="socializing-sign">+</span>
    ...
    if (elementDescriptionElem) elementDescriptionElem.innerText = elementDescription;
